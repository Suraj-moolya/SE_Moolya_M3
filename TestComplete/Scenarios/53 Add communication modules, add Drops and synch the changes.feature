...
@TC_EPE_TE_CS_0017a
@test003
Scenario Outline: Add Communication Modules (BMX DDO 1602) to PLC Bus before deployment
When I Navigate through project browser CE Project Browser RO in refine offline as '<Project Browser RO1>'
And I enterkey Project Browser RO in refine offline
And I Dblclick dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE3>'
And I Click dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE4>'
...
Examples:
  | SlNo. | Project Browser RO1                             | Dialog Panel CE3 | Dialog Panel CE4 |
  | 1     | Configuration$$0 : PLC bus$$0 : BME XBP 0800$$2 | Communication    | BMX DDO 1602     |
  
@TC_EPE_TE_CS_0017b
@test003
Scenario Outline: Add Communication Modules (BMX DDI 1602) to PLC Bus before deployment
When I Navigate through project browser CE Project Browser RO in refine offline as '<Project Browser RO1>'
And I enterkey Project Browser RO in refine offline
And I Dblclick dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE3>'
And I Click dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE4>'
...
Examples:
  | SlNo. | Project Browser RO1                             | Dialog Panel CE3 | Dialog Panel CE4 |
  | 1     | Configuration$$0 : PLC bus$$0 : BME XBP 0800$$3 | Communication    | BMX DDI 1602     |
  
  
@TC_EPE_TE_CS_0017b
@test003
Scenario Outline: Add Communication Modules (BMX AMI 0810) to PLC Bus before deployment
When I Navigate through project browser CE Project Browser RO in refine offline as '<Project Browser RO1>'
And I enterkey Project Browser RO in refine offline
And I Dblclick dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE3>'
And I Click dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE4>'
...
Examples:
  | SlNo. | Project Browser RO1                             | Dialog Panel CE3 | Dialog Panel CE4 |
  | 1     | Configuration$$0 : PLC bus$$0 : BME XBP 0800$$4 | Communication    | BMX AMI 0810     |
  
@TC_EPE_TE_CS_0017d
@test003
Scenario Outline: Add Communication Modules (BMX AMO 0410) to PLC Bus before deployment
When I Navigate through project browser CE Project Browser RO in refine offline as '<Project Browser RO1>'
And I enterkey Project Browser RO in refine offline
And I Dblclick dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE3>'
And I Click dialog panel item CE Dialog Panel CE in dialog ce as '<Dialog Panel CE4>'
...
Examples:
  | SlNo. | Project Browser RO1                             | Dialog Panel CE3 | Dialog Panel CE4 |
  | 1     | Configuration$$0 : PLC bus$$0 : BME XBP 0800$$5 | Communication    | BMX AMO 0410     |