...
Examples:
  ...
  | 1     | Next   | Browse  | Finish  |OK      | This PC/Documents/SE-Shared/GSD files | Close   |
...
Examples:
  | SlNo. | prm             | option      | option2              | option3 | file_name   | button | button2 | button3 |
  | 1     | PRM_Master_0001 | Device menu | Additional functions | Remove  | GSD Library | Delete | Yes     | Close   |